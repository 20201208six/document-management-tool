  ...
  <div class="pd-root">
    ...
    <div class="pd-summary-bar">
      ...
      <div class="pd-summary-item">
        <span class="pds-label">生成模型</span>
        <span class="pds-value" style="font-size:11px;color:#909399">{{ predictionModelName }}</span>
      </div>
      <div class="pd-summary-item">
...
const predictionModelName = computed(() => chatStore.currentModel?.name || '未知模型')
